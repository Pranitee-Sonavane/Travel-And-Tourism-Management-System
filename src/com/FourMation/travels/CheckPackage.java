...
public class CheckPackage extends JFrame{
	...
	public CheckPackage()
	{
	      ...
	      String[] package3 = new String[]{"package2.jpg","BRONZE PACKAGE","6 days and 5 Nights", "Return Airfare", "Free Clubbing, Horse Riding & other Games", "Welcome drinks on Arrival", "Daily Buffet", "Stay in 5 Star Hotel", "BBQ Dinner", "BOOK NOW", "Monsoon Special", "Rs 32000 only"};
